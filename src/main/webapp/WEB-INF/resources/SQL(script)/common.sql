...
//cmd 에서 testuser/testuser 로 로그인해보기.
 ...
 NOCOMPRESS LOGGING
  ...
  INSERT INTO "TESTUSER"."USERS" (USER_UID,USER_ID,USER_PW,USER_NAME,USER_GEN,USER_BIR,USER_MAIL,USER_PNUM,USER_ZCODE,USER_ADDR1,USER_ADDR2,
  USER_CREATEDATE,USER_UPDATEDATE,USER_LASTLOGINDATE,USER_USE) VALUES
  (1,1,'1','1','1',SYSDATE,'THEMAPISTO@NAVER.COM','010-4843-6130',1234,'경기도','성남시',SYSDATE,SYSDATE,SYSDATE,'N');
